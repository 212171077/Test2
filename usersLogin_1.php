...
if($_SERVER['REQUEST_METHOD']=='POST')
{
        ...
        else  if(isset($_POST["btnUpdateProfile"]))
        {
            ...
            $user =new User($_SESSION["user_id"], $_POST["name"], $_POST["surname"], $_POST["province"], $_POST["phone"], $_POST["email"]);
          
            $databaseManager=new DatabaseManager();
            
            $mssg=$databaseManager->updateUser($user) ;
            dispalyMessage($mssg);
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a class="glyphicon glyphicon-home " style="color:white; font-size: 20px" href="#page-top"></a>
                    </li>
                     <li>
                ...
                <div class="panel-heading" > <h4 class="thin text-center">Quick Links</h4></div>
                    <div class="panel-body">
                        ...
                        <li class="btn btn-link">
                            <a class="btn-link" href="#vote">Vote</a>
                        </li>
                         </ul>

                        <ul class=" btn-warning">
                        <li class="btn btn-link">
                            <a class="btn-link" href="#profile">Update profile</a>
                        </li>
                         </ul>
        ...
        <div class="container">
			...
			<div class="panel panel-primary">
			  ...
			  <div class="panel-body">
				...
				<input type="number" class="form-control" id="phone" name="phone" onkeyup="validateEmail()" required placeholder="0729255645" >
                           ...
                           <article class="col-xs-12 maincontent">
                                ...
                                <div class="panel panel-primary">
                                  ...
                                  <div class="panel-body">
                                        ...
                                        <label for="exampleInputName2">ID Number </label> <label id="lblId"></label>
                                        <input type="number" class="form-control" id="id" name="id" onkeyup="validateId()" disabled="true" value="<?php print $_SESSION["user_id"]; ?>" required placeholder="9824342365434" >

                                        <label for="exampleInputName2">Surname </label><label id="lblSurname"></label>
                                        <input type="text" class="form-control" id="surname"  name="surname" onkeyup="validateSurname()" value="<?php print $_SESSION["surname"]; ?>" required name="surname" placeholder="Jane Doe" >

                                        <label for="exampleInputName2">Name </label> <label id="lblName"></label>
                                        <input type="text" class="form-control" id="name" name="name"  onkeyup="validateName()" value="<?php print $_SESSION["name"]; ?>" required placeholder="Jane Doe" >

                                        <label for="exampleInputName2">Province</label><label id="lblgander"></label>
                                        <select name="province"  class="form-control" id="province">
                                          <option ><?php print $_SESSION["province"]; ?></option>
                                          <option >Gauteng</option>
                                          <option>Mpumalanga</option>
                                          <option>Limpopo</option>
                                        </select>
                                        ...
                                        <label for="exampleInputName2">Phone Number </label> <label id="lblPhone"></label>
                                        <input type="number" class="form-control" id="phone" name="phone" onkeyup="validateEmail()" value="<?php print $_SESSION["phone"]; ?>" required placeholder="0729255645" >


                                        <label for="exampleInputName2">Email Address </label> <label id="lblEmail"></label>
                                        <input type="email" class="form-control" id="email" name="email" onkeyup="validateEmail()" value="<?php print $_SESSION["email"]; ?>" required placeholder="john@gmail" >
                                        ...
                                        <table>
                                                ...
                                                <td>
                                                <center><button type="submit" name="btnUpdateProfile"   id="btnUpdateProfile" class="btn btn-primary btn-lg active">Update</button></center>
                                                </td>
