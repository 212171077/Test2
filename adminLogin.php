<?php
//session_start();
 $_SESSION["fromPage"]="adminlogin.php";
                ...
                <div class="panel-heading" > <h4 class="thin text-center">Quick Links</h4></div>
                    <div class="panel-body">
                        ...
                        <li class="btn btn-link">
                            <a class="btn-link" href="addParty.php">Add Political Party</a>
                        </li>
                         </ul>

                        <ul class=" btn-warning">
                        <li class="btn btn-link">
                            <a class="btn-link" href="removeParty.php">Remove Political Party</a>
                        </li>
